...
export default class BasicTower{
    ...
    fire(){
        this.func([new Projectile(this.index,3,this.position,new Vector2(0,1).Nor,`rgb(140,20,200)`,this.range,40,1,1,1),
            new Projectile(this.index,3,this.position,new Vector2(1,1).Nor,`rgb(140,20,200)`,this.range,40,1,1,1),
            new Projectile(this.index,3,this.position,new Vector2(1,0).Nor,`rgb(140,20,200)`,this.range,40,1,1,1),
            new Projectile(this.index,3,this.position,new Vector2(1,-1).Nor,`rgb(140,20,200)`,this.range,40,1,1,1),
            new Projectile(this.index,3,this.position,new Vector2(0,-1).Nor,`rgb(140,20,200)`,this.range,40,1,1,1),
            new Projectile(this.index,3,this.position,new Vector2(-1,-1).Nor,`rgb(140,20,200)`,this.range,40,1,1,1),
            new Projectile(this.index,3,this.position,new Vector2(-1,0).Nor,`rgb(140,20,200)`,this.range,40,1,1,1),
            new Projectile(this.index,3,this.position,new Vector2(-1,1).Nor,`rgb(140,20,200)`,this.range,40,1,1,1)]);
    }
